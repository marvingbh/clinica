...
export const AuditAction = {
  ...
  STRIPE_PAYOUT_DISMISSED: "STRIPE_PAYOUT_DISMISSED",

  // Integrated billing (cobrança via Stripe Connect)
  PAYMENT_CONNECT_STARTED: "PAYMENT_CONNECT_STARTED",
  PAYMENT_CONNECT_DISCONNECTED: "PAYMENT_CONNECT_DISCONNECTED",
  DUNNING_CONFIG_UPDATED: "DUNNING_CONFIG_UPDATED",
  PAYMENT_CHARGE_CREATED: "PAYMENT_CHARGE_CREATED",
  PAYMENT_CHARGE_CANCELED: "PAYMENT_CHARGE_CANCELED",
  PAYMENT_CHARGE_REFUNDED: "PAYMENT_CHARGE_REFUNDED",
  DUNNING_JOB_EXECUTED: "DUNNING_JOB_EXECUTED",
  ...
  // Document generator (CFP) — never include clinical body content in values
  ...
  // Teleconsulta (telehealth) — never include PII in values
  TELECONSULTA_INICIADA: "TELECONSULTA_INICIADA",
  TELECONSULTA_ACESSO_PACIENTE: "TELECONSULTA_ACESSO_PACIENTE",

  // Form builder / anamnese — never include answer content in values
  FORM_TEMPLATE_CREATED: "FORM_TEMPLATE_CREATED",
  FORM_TEMPLATE_UPDATED: "FORM_TEMPLATE_UPDATED",
  FORM_TEMPLATE_PUBLISHED: "FORM_TEMPLATE_PUBLISHED",
  FORM_TEMPLATE_DEACTIVATED: "FORM_TEMPLATE_DEACTIVATED",
  FORM_SENT: "FORM_SENT",

...
const CANCEL_CONFIG: Record<CancelVariant, {
  ...
  faltou: {
    ...
    paymentColor: "bg-amber-50 border-amber-200 text-amber-700",
  ...
  desmarcou: {
    ...
    paymentColor: "bg-teal-50 border-teal-200 text-teal-700",
  ...
  sem_cobranca: {
    ...
    paymentColor: "bg-red-50 border-red-200 text-red-600",

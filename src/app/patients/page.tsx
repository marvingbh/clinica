...
export default function PatientsPage() {
  ...
  const [patientTab, setPatientTab] = useState<"dados" | "historico" | "financeiro" | "prontuario" | "documentos" | "anexos" | "formularios" | "escalas">("dados")
  ...
  function openEditSheet(patient: Patient) {
    ...
    reset(patientToFormData(patient))
    setIsSheetOpen(true)
  }
  ...
  async function onSubmit(data: PatientFormData) {
    ...
    try {
      ...
      const payload = buildPatientPayload({ data, additionalPhones })
      ...
      {isSheetOpen && hasMounted && createPortal(
        <>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center">
            ...
            <div className="w-full max-w-4xl bg-background border-t border-border rounded-t-2xl h-[85vh] overflow-y-auto overflow-x-hidden animate-slide-up">
